...
if(w==2)
{
    ...
    if((x=fopen("sudoku.txt","r"))==NULL){
                                                printf("To read input from a text file, follow these steps -\n");
                                                printf("\n1 Create a new notepad texe file in same location where this software is placed");    
...
int check(int v[9][9][10])
{
    ...
    if(o==9)return 0;else{
     ...
     if(sum==405)return 1;else{return 2;}}
