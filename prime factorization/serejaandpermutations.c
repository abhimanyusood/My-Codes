...
void print(int n, int a[n], int place, int value)//place se just pehle insertion karta hai
{
     ...
     for(i=place;i<n;i++)printf("%d ",a[i]);
...
int main()
{
    ...
    while(t--)
    {
              ...
              printf("\n\n\n");
              for(i=1;i<=2;i++){
              for(j=0;j<n-1;j++)printf("%d ",q[i][j]);printf("\n");}
              printf("\n");
              ...
              //search the first series for this element
              //find the previous element to this
              //if this previous element is 2, then seris is 1,2,thisele                                                                //wz
